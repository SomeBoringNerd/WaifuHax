...
public class SettingPanelBase
{
    ...
    public boolean isHovered(double mouseX, double mouseY){
        return ((mouseX > parent.parent.xSet.getValueInt()) && (mouseX < parent.parent.xSet.getValueInt() + parent.parent.width) && (mouseY > parent.parent.ySet.getValueInt() + parent.offset + offset) && (mouseY < parent.parent.ySet.getValueInt() + parent.offset + offset + 16)) && parent.extended;
    }
}
